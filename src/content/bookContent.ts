...
export const bookContent: BookContent[] = [
    ...
    },
    {
        pageNumber: 1,
        text: [
            `בבית בינוני ולא נקי גר צייר שאהב לצייר.`,
            ``,
        ],
    },
    {
        pageNumber: 2,
        text: [
            `הוא צייר עץ, ועוד מעט הוא יתחיל לצייר את השמיים. הוא טבל את המכחול בצבע הכחול שעל הפלטה,
והתחיל לצייר את השמיים.`
    ...
    },
    {
        pageNumber: 3,
        text: [
            `בשמיים הוא צייר את השמש, וצייר ציפורים.`,
        ],
    },
...
הוא לא ידע איך ייתכן שיש שני ציירים.`,
            `"אני לא מאמין שאתה אני!"
...
`,
    ...
    },
    {
        pageNumber: 11,
        text: [
            `כשהגיעו — הוא הגיע לגן השעשועים. ושם מצא את הדמות.
